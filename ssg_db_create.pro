...
;  printf, lun, 'jnp               R*4          Jovian north pole position angle (deg)'
  ...
  printf, lun, 'nn_Gw             R*4          Nearest neighbor Gaussian width'
  printf, lun, 'nn_Lw             R*4          Nearest neighbor Lorentzian width'
  printf, lun, 'n2_DOWL           R*4          2nd nearest neighbor Delta Observed Wavelength (Angstroms)'
  printf, lun, 'n2_ew             R*4          2nd nearest neighbor equivalent width'
  printf, lun, 'n2_Gw             R*4          2nd nearest neighbor Gaussian width'
  printf, lun, 'n2_Lw             R*4          2nd nearest neighbor Lorentzian width'
  printf, lun, 'tell_av_Gw        R*4          Telluric average Gaussian width'
  printf, lun, 'tell_med_Gw       R*4          Telluric median Gaussian width' 
  printf, lun, 'tell_av_Lw        R*4          Telluric average Lorentzian width'
  printf, lun, 'tell_med_Lw       R*4          Telluric median Lorentzian width' 
...
;  printf, lun, 'n_xdisp		  I*2          number of elements in cross-dispersion spectrum'
  ...
  printf, lun, 'nn_Gw             F10.2        NEAREST_NEIGHBOR,GAUS_WIDTH,mA'
  printf, lun, 'nn_Lw             F10.2        NEAREST_NEIGHBOR,LOR_WIDTH,mA'
  printf, lun, 'n2_DOWL           F10.2        2ND_NEAREST_NEIGHBOR,DOWL,mA'
  printf, lun, 'n2_ew             F10.2        2ND_NEAREST_NEIGHBOR,EQUIV_WIDTH,mA'
  printf, lun, 'n2_Gw             F10.2        2ND_NEAREST_NEIGHBOR,GAUS_WIDTH,mA'
  printf, lun, 'n2_Lw             F10.2        2ND_NEAREST_NEIGHBOR,LOR_WIDTH,mA'
  printf, lun, 'tell_av_Gw        F10.2        TELLURIC,AV_GAUSS_WIDTH,mA'
  printf, lun, 'tell_med_Gw       F10.2        TELLURIC,MED_GAUSS_WIDTH,mA'
  printf, lun, 'tell_av_Lw        F10.2        TELLURIC,AV_LOR_WIDTH,mA'
  printf, lun, 'tell_med_Lw       F10.2        TELLURIC,MED_LOR_WIDTH,mA'
  printf, lun, ''
